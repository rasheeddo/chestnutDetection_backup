...
def runOnVideo(net, meta, vid_source, thresh=.5, hier_thresh=.5, nms=.45):
        #X1=[0.   ,0.   ,0.   ]
        X2=[850. ,0    ,0.   ]#X2=[420. ,0    ,0.   ]
        X3=[0. ,-480.   ,0.   ]#X3=[0. ,-230.   ,0.   ]
        X1=[0   , 0   ,0.   ]
       # X2=[230. ,0    ,0.   ]
       # X3=[0. ,-170.   ,0.   ]
        X =[0.   ,0.   ,0.   ]
 ...
 #  video.set(cv2.CV_CAP_PROP_FPS,0.5)
        ...
        while video.isOpened():
            ...
            if len(r)>0:
                ...
                print("X",X)                
                XX = map(P[0],0,640,-850.0/2.0, 850.0/2.0) # use map() give similar result as coor_g()
                YY = map(P[1],0,480,480.0/2.0,-480.0/2.0)
                print("XX",XX)
                print("YY",YY)
                #deltarobot.DeltaGoPoint(X[0],X[1],-650)
