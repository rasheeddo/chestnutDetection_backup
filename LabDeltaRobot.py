...
class DeltaRobot:
	def __init__(self):
		...
		self.maxR = 500.0 			#300 delta MK1				
		self.minStoke = -350.0		#-300 delta MK1	
		...
		## Gripper Constraint
		self.GRIPPER_OPEN = 2350
		self.GRIPPER_CLOSE = 1840
		...
		# Goal Current Set ###
		self.SetGoalCurrentGripper(250)

		self.SetTimeBaseProfile(self.DXL4_ID,500,350)   #(ID,Tf,Ta) 
		...
		if ( (self.GetOperatingMode(self.DXL1_ID)==3) and (self.GetOperatingMode(self.DXL2_ID)==3) and (self.GetOperatingMode(self.DXL3_ID)==3) ):
			...
			# Set PID gain 
			P_Gain1 = 2000    #800 default
			I_Gain1 = 1000     #0 default
			D_Gain1 = 4000   #4700 default

			P_Gain2 = 2000    #800 default
			I_Gain2 = 1000     #0 default
			D_Gain2 = 4000   #4700 default

			P_Gain3 = 2000    #800 default
			I_Gain3 = 1000     #0 default
	...
	def ReadAllCurrent(self):
		...
		com_signed_value1 = numpy.int16(dxl_present_current1)
		com_signed_value2 = numpy.int16(dxl_present_current2)
		com_signed_value3 = numpy.int16(dxl_present_current3)
